...
<template>
    <div>
        ...
        <div class="relative md:ml-64 bg-blueGray-100">
            ...
            <div class="relative blueGray-100 md:pt-32 pb-32 pt-12">

                <div class="px-4 md:px-10 mx-auto w-full">

                    <div class="py-12">
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            <h1 class="text-2xl">Upload Your .xls File</h1>
                            <!-- 👇 Photo creation form goes here -->
                            <form @submit.prevent="submit">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700"> Af en Bijschriften </label>
                                    <div
                                        ...
                                        <div class="space-y-1 text-center">
                                            ...
                                            <p class="text-xs text-gray-500">XLS</p>
                                        </div>
                                    </div>
                                </div>
